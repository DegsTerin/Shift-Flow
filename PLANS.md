...
- Dashboard reads still provision defaults and dashboard configuration writes
  are not yet one atomic command. The completed-duration sample is bounded but
