# Auditoria de UI/UX e Qualidade Visual

Este playbook especializado herda as regras de estado, escopo, commit e evidencias de `../Start-Here.md`, `../core/Governance.md` e `../core/Quality-Gates.md`.

Ele nao autoriza nova funcionalidade, regra de negocio, alteracao de API, schema, migration, permissao, persistencia ou fluxo funcional. Alteracoes em componentes compartilhados, CSS global, Design System, navegacao ou comportamento de interface em `STATE-08` sao manutencao pos-release. Registrar qualquer expansao funcional necessaria como achado, salvo autorizacao explicita.
