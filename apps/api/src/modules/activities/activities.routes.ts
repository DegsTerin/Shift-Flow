...
import { activitySchema, assignActivitySchema, moveActivitySchema } from "./activities.validators.js";
...
activityRoutes.post("/", requirePermission("activities", "write"), validate("body", activitySchema), ActivitiesController.create);
activityRoutes.get("/:id", requirePermission("activities", "read"), ActivitiesController.get);
activityRoutes.patch("/:id", requirePermission("activities", "write"), validate("body", activitySchema.partial()), ActivitiesController.update);
activityRoutes.delete("/:id", requirePermission("activities", "delete"), ActivitiesController.remove);
