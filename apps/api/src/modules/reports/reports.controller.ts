// en-GB: Handles reports HTTP requests so transport concerns remain separate from business behaviour.
...
export const ReportsController = {
  ...
  submit: asyncHandler(async (req: ApiRequest, res: Response) => {
    res.json(ok(await service.submit(req, uuidParam(req.params.id, "id"))));
  }),
