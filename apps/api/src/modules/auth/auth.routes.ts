...
import { directAccessRateLimit } from "../../shared/middlewares/rate-limit.js";
...
authRoutes.post("/demo", directAccessRateLimit, AuthController.demo);
authRoutes.post("/portfolio", directAccessRateLimit, AuthController.portfolio);
